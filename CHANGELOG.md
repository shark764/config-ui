...
## [4.103.4] - 2021-06-23
### Fixed
* CXV1-24132 - Bumped SDK version to 10.1.3, updating update-capacity-rules to add the new capacity rule to the agent before removing the old one

## [4.103.3] - 2021-06-15
### Fixed
* CXV1-24430 - Add items per page functionality to RTD tables pagination.
...
- [CXV1-23468](https://lifesize.atlassian.net/browse/CXV1-23468) - Non mp4 video files show proper filename and mp4 videos show caption when included in message.
...
### Fixed
- [CXV1-23240](https://lifesize.atlassian.net/browse/CXV1-23240) - Getting rid of uppercase transform of interaction-id in addDock.
...
- [CXV1-22445](https://liveops.atlassian.net/browse/CXV1-22445) - Remove silent monitoring page from navbar
- [CXV1-22455](https://liveops.atlassian.net/browse/CXV1-22455) - Fix mute button
...
## [4.88.8] - 2020-07-21
### Fixed
- [CXV1-13650](https://liveops.atlassian.net/browse/CXV1-13650) - Config UI - "Please enter a password" needs updated
...
## [4.88.4] - 2020-06-30
### Fixed
- <no-Jira> - Bump sdk to version 9.9.3
...
- <CXV1-22760> -  Update Permissions to view Early Access
...
## [4.87.5] - 2020-04-24
### Fixed
- No Jira - Setting up automated PR assignment
...
## [4.87.2] - 2020-04-24
### Fixed
- [CXV1-16021](https://liveops.atlassian.net/browse/CXV1-16021) - After enabling several options the side panel can´t display correctly the elements.
...
## [4.86.4] - 2020-04-15
### Fixed
- <no-Jira> - upadated new teams webhooks in jenkinsfile.
...
## [4.82.9](https://github.com/serenovallc/config-ui/compare/4.82.8...4.82.9) - 2020-01-20
### Fixed
- [CXV1-21383](https://liveops.atlassian.net/browse/CXV1-21383) Fix chat widget page read permission
