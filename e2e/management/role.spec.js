...
describe('The role view', function() {
  ...
  it('should display default roles', function() {
    ...
    expect(shared.firstTableRow.getText()).toContain('41');
    ...
    expect(shared.firstTableRow.getText()).toContain('5');
    ...
    expect(shared.firstTableRow.getText()).toContain('12');
  });
  ...
  it('should not allow updates to Administrator role', function() {
    ...
    expect(role.rolePermissions.count()).toBe(41);
    expect(role.detailsPermissionCount.getText()).toBe('(41)');
  });
  ...
  it('should not allow updates to Agent role', function() {
    ...
    expect(role.rolePermissions.count()).toBe(5);
    expect(role.detailsPermissionCount.getText()).toBe('(5)');
  });
  ...
  it('should not allow updates to Supervisor role', function() {
    ...
    expect(role.rolePermissions.count()).toBe(12);
    expect(role.detailsPermissionCount.getText()).toBe('(12)');
  });
