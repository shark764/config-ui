...
var MediaCollectionsPage = function() {
  ...
  this.voiceFormDropdown = this.createMediaForm.element(by.id('tts-property-voice-field'));
  this.voiceOptions = this.voiceFormDropdown.all(by.css('option'));
  this.languageFormDropdownField = this.createMediaForm.element(by.id('tts-property-language-field'));
