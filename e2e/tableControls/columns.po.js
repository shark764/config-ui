...
var Columns = function() {
  ...
  this.tenants = ['Name', 'Description', 'Identifier', 'Parent Tenant', 'Status'];
  ...
  this.columnOneHeader = this.tableHeader.element(by.css('th:nth-child(1)'));
  this.columnTwoHeader = this.tableHeader.element(by.css('th:nth-child(2)'));
  this.columnThreeHeader = this.tableHeader.element(by.css('th:nth-child(3)'));
  this.columnFourHeader = this.tableHeader.element(by.css('th:nth-child(4)'));
  this.columnFiveHeader = this.tableHeader.element(by.css('th:nth-child(5)'));
  this.columnSixHeader = this.tableHeader.element(by.css('th:nth-child(6)'));
  this.columnSevenHeader = this.tableHeader.element(by.css('th:nth-child(7)'));
  this.columnEightHeader = this.tableHeader.element(by.css('th:nth-child(8)'));
  this.columnNineHeader = this.tableHeader.element(by.css('th:nth-child(9)'));
  this.columnTenHeader = this.tableHeader.element(by.css('th:nth-child(10)'));
  this.columnElevenHeader = this.tableHeader.element(by.css('th:nth-child(11)'));
