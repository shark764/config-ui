...
angular.module('liveopsConfigPanel')
  .controller('HistoricalReportsController', ['$scope', '$sce', '$http', 'Session', 'HistoricalReport', '$state', 'BIRST_URL',
    function($scope, $sce, $http, Session, HistoricalReport, $state, BIRST_URL) {
      $scope.birst = {};

      $scope.fetch = function() {

        HistoricalReport.get({
