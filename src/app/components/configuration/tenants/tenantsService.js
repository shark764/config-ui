...
angular.module('liveopsConfigPanel')
  .factory('Tenant', ['LiveopsResourceFactory', 'emitInterceptor', 'queryCache', 'cacheAddInterceptor',
    function (LiveopsResourceFactory, emitInterceptor, queryCache, cacheAddInterceptor) {
