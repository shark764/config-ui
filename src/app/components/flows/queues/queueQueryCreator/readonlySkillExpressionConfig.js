...
angular.module('liveopsConfigPanel')
  .service('readonlySkillExpressionConfig', ['Session', 'Skill', 'jsedn',
    function (Session, Skill, jsedn) {
      ...
      return [{
          ...
          template: 'app/components/flows/queues/queueQueryCreator/queryModifierTemplates/readonlySkillsQuery.html'
        }, {
          keyword: ':skills',
          options: fetchSkills,
          operator: 'or',
