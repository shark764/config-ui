...
describe('UserPermissions Service', function() {
  ...
  describe('resolvePermissions function', function() {
    ...
    it('should resolve the returned promise if the user has at least one of the permissions given', inject(function($timeout) {
    ...
    it('should reject the returned promise if the user does not have at least one of the permissions given', inject(function($timeout) {
